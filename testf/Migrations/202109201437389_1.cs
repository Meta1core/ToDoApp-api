    ...
    public partial class _1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateStoredProcedure(
                ...
                body:
                    @"UPDATE `Directory` SET `DirectoryName`=@DirectoryName, `User_Id`=@User_Id WHERE `Id` = @Id;"
            );
            ...
            CreateStoredProcedure(
                ...
                body:
                    @"DELETE FROM `Directory` WHERE (`Id` = @Id) AND ((`User_Id` = @User_Id) OR ((`User_Id` IS  NULL) AND (@User_Id IS  NULL)));"
            );
            ...
            CreateStoredProcedure(
                ...
                body:
                    @"UPDATE `ToDoTask` SET `Description`=@Description, `Header`=@Header, `IsFavorite`=@IsFavorite, `IsDone`=@IsDone, `IsOverdue`=@IsOverdue, `DateOfTask`=@DateOfTask, `Directory_Id`=@Directory_Id, `User_Id`=@User_Id WHERE `Id` = @Id;"
            );
            ...
            CreateStoredProcedure(
                ...
                body:
                    @"DELETE FROM `ToDoTask` WHERE ((`Id` = @Id) AND ((`Directory_Id` = @Directory_Id) OR ((`Directory_Id` IS  NULL) AND (@Directory_Id IS  NULL)))) AND ((`User_Id` = @User_Id) OR ((`User_Id` IS  NULL) AND (@User_Id IS  NULL)));"
            );
